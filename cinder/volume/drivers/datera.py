...
class DateraDriver(san.SanISCSIDriver):
    ...
    def create_volume(self, volume):
        ...
        params = {
            ...
            'size': str(volume['size'] * units.GiB),
            'uuid': volume['id'],
    ...
    def detach_volume(self, context, volume):
        try:
            ...
            msg = ("Tried to delete export for volume %s, but it was not "
    ...
    def delete_snapshot(self, snapshot):
        try:
            ...
            msg = ("Tried to delete snapshot %s, but was not found in Datera "
    ...
    def _issue_api_request(self, resource_type, method='get', resource=None,
        ...
        try:
            ...
            msg = ('Failed to make a request to Datera cluster endpoint due '
        ...
        if not response.ok:
            if response.status_code == 404:
                ...
                msg = ('Request to Datera cluster returned bad status:'
                       ' %(status)s | %(reason)s') % {
